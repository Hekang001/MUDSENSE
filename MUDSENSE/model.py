...
class Model(nn.Module):
    def __init__(self, config):
        ...
        # self.bert = AutoModel.from_pretrained("model/bert-base-chinese", output_hidden_states=True)
        self.bert = AutoModel.from_pretrained("./MUDSENSE/model/bert-base-chinese", output_hidden_states=True)
